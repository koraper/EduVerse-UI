    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card>
            <div className="p-6">
              ...
              <div className="mt-4">
                <span className="text-xs text-success-600 font-medium">+2 이번 학기</span>
              </div>
            </div>
          </Card>
          ...
          <Card>
            <div className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">전체 학생 수</p>
              ...
              <div className="mt-4">
                <span className="text-xs text-success-600 font-medium">+15 이번 달</span>
              </div>
            </div>
          </Card>
          ...
          <Card>
            <div className="p-6">
              ...
              <div className="mt-4">
                <span className="text-xs text-warning-600 font-medium">채점 필요</span>
              </div>
            </div>
          </Card>
          ...
          <Card>
            <div className="p-6">
              ...
              <div className="mt-4">
                <span className="text-xs text-success-600 font-medium">+3% 지난주 대비</span>
              </div>
            </div>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <div className="p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">최근 제출물</h2>
                ...
                {[1, 2, 3].map((i) => (
                  <div key={i} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900">학생 {i}의 제출물</p>
                        <p className="text-xs text-gray-500">2시간 전</p>
                      </div>
                    </div>
                    <Badge variant="warning">미채점</Badge>
                  </div>
                ))}
              </div>
            </div>
          ...
          <Card>
            <div className="p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">수업 일정</h2>
              <div className="space-y-4">
                {[
